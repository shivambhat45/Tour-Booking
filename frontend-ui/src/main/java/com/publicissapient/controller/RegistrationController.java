...
public class RegistrationController {
	...
	public ModelAndView homePage()
	{
        ...
        ResponseEntity<List<PackageDto>> response = restTemplate.exchange("http://localhost:8087/customer/listPackages", HttpMethod.GET, req,
	...
	public ModelAndView listUsers()
	{
        ...
        ResponseEntity<List<UserDto>> response = restTemplate.exchange("http://localhost:8087/list", HttpMethod.GET, req,
	...
	public ModelAndView saveUser(SignUpDto signUpDto) {
		...
		ResponseEntity<UserDto> response = restTemplate.exchange("http://localhost:8087/registration", HttpMethod.POST,
				req, UserDto.class);
