...
public class AdminController {
	...
	public ModelAndView savePackage(PackageDto packageDto) {
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8087/admin/createPackage", HttpMethod.POST,
				req, String.class);
	...
	public ModelAndView updatePackageInfo(PackageDto packageDto) {
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8087/admin/updatePackage", HttpMethod.PUT,
				req, String.class);
	...
	public ModelAndView deletePackageInfo(String packageName) {
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8087/admin/deletePackage/"+packageName, HttpMethod.DELETE,
				req, String.class);
	...
	public ModelAndView listBooking()
	{
        ...
        ResponseEntity<List<BookingDto>> response = restTemplate.exchange("http://localhost:8087/admin/listBookings", HttpMethod.GET, req,
	...
	public ModelAndView deleteBookingInfo(Integer bookingId) {
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8087/admin/deleteBooking/"+bookingId, HttpMethod.DELETE,
				req, String.class);
	...
	public ModelAndView assignStaffInfo(Integer staffId,Integer bookingId) {
		...
		ResponseEntity<String> response = restTemplate.exchange("http://localhost:8087/admin/assignStaff/"+staffId+"/"+bookingId, HttpMethod.PUT,
				req, String.class);
